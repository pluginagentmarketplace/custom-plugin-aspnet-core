# Aspnet Core Advanced Guide

## Overview

This guide provides comprehensive documentation for the **aspnet-core-advanced** skill in the custom-plugin-aspnet-core plugin.
...
```bash
# Invoke the skill
claude "aspnet-core-advanced - [your task description]"

# Example
claude "aspnet-core-advanced - analyze the current implementation"
```
...
def implement_aspnet_core_advanced(input_data):
    """
    Implement aspnet-core-advanced functionality.
